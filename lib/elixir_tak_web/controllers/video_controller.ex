defmodule ElixirTAKWeb.VideoController do
  ...
  defp build_vcm_feed(stream) do
    ...
    IO.iodata_to_binary([
      "<feed>",
      "<protocol>", xml_escape(proto), "</protocol>",
      "<alias>", xml_escape(stream.alias || "Video Stream"), "</alias>",
      "<uid>", xml_escape(stream.uid), "</uid>",
      "<address>", xml_escape(addr), "</address>",
